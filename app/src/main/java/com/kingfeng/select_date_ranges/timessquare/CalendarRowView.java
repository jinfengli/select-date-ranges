...
//      int cellHeightSpec = isHeaderRow ? makeMeasureSpec(cellSize, AT_MOST) : (int)(cellWidthSpec * 0.66);
      int cellHeightSpec = isHeaderRow ? makeMeasureSpec(cellSize, MeasureSpec.AT_MOST) : cellWidthSpec - 20;
